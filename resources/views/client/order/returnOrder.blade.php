                            ...
                            <div class="entry-content">
                                <div class="woocommerce">
                                    <div class="woocommerce-order">
                                        <h2>Thông tin đơn hàng hoàn trả</h2>
                                        ...
                                        <form action="{{ route('client.orders.return.submit', ['id' => $order->id]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small id="cancel_reason_error" class="text-danger"
                                                    style="display: none; font-size: 1.2em;">Vui lòng nhập lý do hoàn đơn</small>
                                            </div>
                                            <button type="submit" class="btn btn-danger"
                                                onclick="return confirm('Bạn có chắc chắn muốn hoàn trả đơn hàng này?')">Hoàn Đơn</button>
...
<script>
    function validateCancelReason() {
        ...
        if (!reason || reason.length < 10) {
            errorElement.textContent = 'Vui lòng nhập lý do hoàn đơn ít nhất 10 ký tự.';
