        ...
        <div class="products">
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/5.jpg" width="224" height="197"
                ...
                <div class="hover-area">
                    <a class="button add_to_cart_button" href="{{ route('client.cart.index') }}" rel="nofollow">Add to
                        cart</a>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/16.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/8.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/11.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/10.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
                ...
                <div class="hover-area">
                    <a class="button add_to_cart_button" href="{{ route('client.cart.index') }}" rel="nofollow">Add
                        to cart</a>
                    <a class="add-to-compare-link" href="compare.html">Add to
                        compare</a>
                </div>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/15.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/6.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    ...
                    <img src="{{ url('') }}/home/assets/images/products/14.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> 262.81</span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    ...
                    <img src="{{ url('') }}/home/assets/images/products/2.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    ...
                    <img src="{{ url('') }}/home/assets/images/products/7.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/4.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/3.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/13.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/9.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/1.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
            ...
            <div class="product">
                ...
                <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                    <img src="{{ url('') }}/home/assets/images/products/12.jpg" width="224" height="197"
                        class="wp-post-image" alt="">
                    <span class="price">
                        <ins>
                            <span class="amount"> </span>
...
<div class="woocommerce-tabs wc-tabs-wrapper">
    ...
    <div class="tab-content">
                ...
                <div class="accessories-wrapper">
                                ...
                                <div class="checkbox accessory-checkbox">
                                    <label>
                                        <input type="checkbox" data-product-type="simple" data-product-id="185"
                                            data-price="997.00" class="product-check" checked="">
                                        Remove
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="accessories-product-total-price">
                        ...
                        <div class="accessories-add-all-to-cart">
                            <button class="button btn btn-primary add-all-to-cart" type="button">Add Bundle to
                                cart</button>
                        </div>
        ...
        <div class="tab-pane panel wc-tab" id="tab-description" role="tabpanel">
            ...
            <div class="outer-wrap">
                <div class="image-info">
                    <img src="{{ url('') }}/home/assets/images/products/des2.png" class="alignnone"
                        alt="">
                </div>
                <!-- .image-info -->
                <div class="content-info">
                            ...
                            <div id="review_form">
                                <div class="comment-respond" id="respond">
                                    ...
                                    <form novalidate="" class="comment-form" id="commentform" method="post"
                                        ...
                                        <div class="comment-form-rating">
                                            ...
                                            <p class="stars">
                                                <span><a href="#" class="star-1">1</a><a href="#"
                                                        class="star-2">2</a><a href="#" class="star-3">3</a><a
                                                        href="#" class="star-4">4</a><a href="#"
                                        ...
                                        <p class="form-submit">
                                            <input type="submit" value="Add Review" class="submit" id="submit"
                                                name="submit">
                ...
                <div class="products">
                        ...
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-6.jpg" alt="">
                    ...
                    <div class="landscape-product product">
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-3.jpg" alt="">
                                <div class="media-body">
                                    <span class="price">
                                        <ins>
                    ...
                    <div class="landscape-product product">
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-4.jpg" alt="">
                                <div class="media-body">
                                    <span class="price">
                                        <ins>
                                            <span class="amount"> </span>
                    ...
                    <div class="landscape-product product">
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-5.jpg" alt="">
                                <div class="media-body">
                                    <span class="price">
                                        <ins>
                                            <span class="amount"> $3,788.00</span>
                    ...
                    <div class="landscape-product product">
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-2.jpg" alt="">
                                <div class="media-body">
                                    <span class="price">
                                        <ins>
                                            <span class="amount"> </span>
                    ...
                    <div class="landscape-product product">
                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                            <div class="media">
                                <img class="wp-post-image"
                                    src="{{ url('') }}/home/assets/images/products/card-1.jpg" alt="">
                                <div class="media-body">
                                    <span class="price">
                                        <ins>
                                            <span class="amount"> $3,788.00</span>
