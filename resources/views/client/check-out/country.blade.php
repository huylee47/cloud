    ...
    <div class="woocommerce-additional-fields">
        <div class="woocommerce-additional-fields__field-wrapper">
            <p id="order_comments_field" class="form-row notes">
                <label class="" for="order_comments">Ghu chú</label>
                <textarea cols="5" rows="2" placeholder="Viết lời nhắn của bạn" id="order_comments" class="input-text " name="order_comments"></textarea>
            </p>
        </div>
